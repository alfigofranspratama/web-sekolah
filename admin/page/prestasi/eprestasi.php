                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <form method="post" action="action.php?aksi=eprestasi&id_posts=<?= $data['id_posts']; ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img src="image/prestasi/<?= $data['thumbnail']; ?>" class="img img-thumbnail" alt="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
