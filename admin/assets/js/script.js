...
$("body").append('<div class="fixed-button active"><a href="https://instagram.com/alfigofransp" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-graduation-cap" aria-hidden="true"></i> SMKN 4 Payakumbuh</a> </div>');var $window=$(window),nav=$(".fixed-button");
