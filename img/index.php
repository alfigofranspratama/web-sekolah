...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/logo/logoweb.png">
...
<style>
    ...
    .header-area .header-bottom ul li {
        margin-bottom: -5px;
    }
</style>
                        ...
                        <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>
                                        <li class="title"><span class="graduation-cap"></span>SMK NEGERI 4 PAYAKUMBUH</li>
                                        <li>BLUETECH IT SCHOOL</li>
                                    </ul>
                                </div>
                                <div class="header-info-right">
                                    <ul class="header-date">
                                        <li><span class="flaticon-calendar"></span> <?= Tanggal(date("Y-m-d")) . " " . date("H:i:s"); ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-6 col-sm-6">
                                    <div class="whats-news-paper">
                                        <!-- Most Recent Area -->
                                        <div class="most-recent-area" style="background-color: #fff; padding: 10px; border-radius: 10px;">
                                            <!-- Section Tittle -->
                                            ...
                                            <div class="most-recent mb-40">
                                                <div class="most-recent-img">
                                                    <img src="assets/img/gallery/kepsek.jpg" alt="" style="width: 100%;">
                                                </div>
                                                <div class="most-recent-capt">
                                                    <h4><a href="latest_news.html">Sambutan Kepala Sekolah</a></h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row justify-content-between align-items-end mb-15">
                                <div class="col-xl-4">
                                    <div class="section-tittle mb-30">
                                        <h3 style="text-transform: uppercase;">Kabar</h3>
                                    </div>
                                </div>
